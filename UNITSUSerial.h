...
#ifndef UNITSUSerial_h
#define UNITSUSerial_h
...
#ifdef ESP32
  #define NR_UNITSU_SERIAL_TYPES 3 // Serial 0, 1, 2
#endif
#if !defined(DISABLE_SOFTWARE_SERIAL) && defined(ESP8266)
  #define NR_UNITSU_SERIAL_TYPES 4 // Serial 0, 1, 0_swap, software
#else
  #define NR_UNITSU_SERIAL_TYPES 3 // Serial 0, 1, 0_swap
#endif
...
struct UNITSUSerialType {
  ...
  static bool getSerialTypePins(UNITSUSerialType::serialtype serType, int& rxPin, int& txPin) {
    rxPin = -1;
    txPin = -1;
    switch (serType) {
      case UNITSUSerialType::serialtype::serial0:  rxPin = 3; txPin = 1; return true;
#ifdef ESP32
      case UNITSUSerialType::serialtype::serial1:  rxPin = 13; txPin = 15; return true;
      case UNITSUSerialType::serialtype::serial2:  rxPin = 16; txPin = 17; return true;
#endif
#ifdef ESP8266
      case UNITSUSerialType::serialtype::serial0_swap:  rxPin = 13; txPin = 15; return true;
      case UNITSUSerialType::serialtype::serial1:       rxPin = -1; txPin = 2; return true;
    #ifndef DISABLE_SOFTWARE_SERIAL
      case UNITSUSerialType::serialtype::software:      rxPin = 14; txPin = 12; return true;
...
#ifdef ESP32
  static UNITSUSerialType::serialtype getSerialType(int receivePin, int transmitPin) {
...
class UNITSUSerial : public Stream
{
public:
  ...
  UNITSUSerial(int receivePin, int transmitPin, bool inverse_logic = false, unsigned int buffSize = 64);
  virtual ~UNITSUSerial();
  ...
  UNITSUSerial(int receivePin, int transmitPin, bool inverse_logic = false, int serialPort = -1);
  virtual ~UNITSUSerial();
...
private:
...
#if !defined(DISABLE_SOFTWARE_SERIAL) && defined(ESP8266)
  bool isSWserial() const { return _serialtype == UNITSUSerialType::serialtype::software; }

  UNITSUSoftwareSerial* _swserial = nullptr;
#else
  ...
  UNITSUSerialType::serialtype _serialtype = UNITSUSerialType::serialtype::MAX_SERIAL_TYPE;
  int _receivePin;
  int _transmitPin;
